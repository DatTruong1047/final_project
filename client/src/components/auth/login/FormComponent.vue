<template>
  ...
  >
    <p class="flex mb-6 lg:text-5xl text-3xl font-normal antialiased pb-4">Sign in</p>
    ...
    <div class="relative z-0 w-full mb-5 md:mt-4 group">
      <Field
        type="password"
        name="password"
        id="password"
    ...
    <button
      type="submit"
      class="flex text-white bg-red-500 lg:text-xl md:py-4 justify-center-safe hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm sm:w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 disabled:bg-gray-400 disabled:text-gray-200 disabled:cursor-not-allowed"
      :disabled="isDisabled"
    >
      Sign In
    </button>
